...
implementation{
	...
	*/
	...
	/*
	Pointer to "acceleration_msg_t" structures (see header "Network.h"), representing the payload of message buffers
	...
	*/
	...
	as the variable "ROOT_ID" (see header "Network.h"), namely it is designed to be the root of the collection tree, the mote sets himself as
	...
	*/
	...
	UART; the size of the queue can be tuned, as well as the sampling period, by mean of variables in the header file "Network.h"
	*/
